...
public class LectureBD {
   ...
   private void insertionPersonne(int id, String nom, String anniv, String lieu, String photo, String bio) {
      ...
      try {
         ...
         stInsertPersonne.addBatch();
      } catch (SQLException ex) {
         System.out.println("Error inserting person: " + ex.getMessage());
      }
   }
   ...
   private void insertionFilm(int id, String titre, int annee,
      ...
      try {
         ...
         System.out.println("Error inserting film: " + ex.getMessage());
      }
   }
   ...
   private void insertionClient(int id, String nomFamille, String prenom,
      ...
      try {
         stInsertClient.setInt(1, id);
         stInsertClient.setString(2, nomFamille);
         stInsertClient.setString(3, prenom);
         stInsertClient.setString(4, courriel);
         stInsertClient.setString(5, tel);
         stInsertClient.setDate(6, Date.valueOf(anniv));
         stInsertClient.setString(7, adresse);
         stInsertClient.setString(8, ville);
         stInsertClient.setString(9, province);
         stInsertClient.setString(10, codePostal);
         stInsertClient.setString(11, carte);
         stInsertClient.setString(12, noCarte);
         stInsertClient.setInt(13, expMois);
         stInsertClient.setInt(14, expAnnee);
         stInsertClient.setString(15, motDePasse);
         stInsertClient.setString(16, forfait);

         stInsertClient.addBatch();
      } catch (SQLException ex) {
